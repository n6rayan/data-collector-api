...
aws --endpoint-url http://localstack:4566 lambda create-function --function-name retry-provider --zip-file fileb://lambda-retry-provider/function.zip --runtime nodejs12.x --timeout 10 --role arn:aws:iam::000000000000:role/lambda-role --handler index.handler  --region eu-west-1
